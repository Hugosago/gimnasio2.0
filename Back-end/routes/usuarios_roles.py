...
@usuario_rol.get('/usersrols/', response_model=List[schemas.usuarios_roles.Usuario_Rol],tags=['Usuarios-Roles'],dependencies=[Depends(Portador())])
...
@usuario_rol.post("/usersrol/{usuario_id}/{rol_id}", response_model=schemas.usuarios_roles.Usuario_Rol, tags=["Usuarios-Roles"], dependencies=[Depends(Portador())])
...
@usuario_rol.put("/usersrol/{usuario_id}/{rol_id}", response_model=schemas.usuarios_roles.Usuario_Rol, tags=["Usuarios-Roles"], dependencies=[Depends(Portador())])
...
@usuario_rol.delete('/usersrols/{usuario_id}/{rol_id}', response_model=schemas.usuarios_roles.Usuario_Rol,tags=['Usuarios-Roles'], dependencies=[Depends(Portador())])
